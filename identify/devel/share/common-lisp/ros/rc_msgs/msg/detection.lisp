...
(cl:defmethod cl:initialize-instance :after ((m <detection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'detection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rc_msgs-msg:<detection> is deprecated: use rc_msgs-msg:detection instead.")))

(cl:ensure-generic-function 'label-val :lambda-list '(m))
(cl:defmethod label-val ((m <detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc_msgs-msg:label-val is deprecated.  Use rc_msgs-msg:label instead.")
  (label m))
...
(cl:defmethod x1-val ((m <detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc_msgs-msg:x1-val is deprecated.  Use rc_msgs-msg:x1 instead.")
  (x1 m))

(cl:ensure-generic-function 'y1-val :lambda-list '(m))
(cl:defmethod y1-val ((m <detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc_msgs-msg:y1-val is deprecated.  Use rc_msgs-msg:y1 instead.")
  (y1 m))

(cl:ensure-generic-function 'x2-val :lambda-list '(m))
(cl:defmethod x2-val ((m <detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc_msgs-msg:x2-val is deprecated.  Use rc_msgs-msg:x2 instead.")
  (x2 m))

(cl:ensure-generic-function 'y2-val :lambda-list '(m))
(cl:defmethod y2-val ((m <detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc_msgs-msg:y2-val is deprecated.  Use rc_msgs-msg:y2 instead.")
  (y2 m))

(cl:ensure-generic-function 'contours-val :lambda-list '(m))
(cl:defmethod contours-val ((m <detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc_msgs-msg:contours-val is deprecated.  Use rc_msgs-msg:contours instead.")
  (contours m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<detection>)))
  ...
  "23cb67375d6ff3ac17afa20ebc5a5cd0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'detection)))
  "Returns md5sum for a message object of type 'detection"
  "23cb67375d6ff3ac17afa20ebc5a5cd0")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<detection>)))
  ...
  (cl:format cl:nil "int32 label~%float32 score~%float32 x1~%float32 y1~%float32 x2~%float32 y2~%point[] contours~%~%================================================================================~%MSG: rc_msgs/point~%float32 x~%float32 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'detection)))
  "Returns full string definition for message of type 'detection"
  (cl:format cl:nil "int32 label~%float32 score~%float32 x1~%float32 y1~%float32 x2~%float32 y2~%point[] contours~%~%================================================================================~%MSG: rc_msgs/point~%float32 x~%float32 y~%~%~%"))
